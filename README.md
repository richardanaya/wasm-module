...
# Functionality
- [x] [console/alerting](https://richardanaya.github.io/webidl-loader/examples/helloworld/src/lib.rs)
- [x] [basic basic dom and dom events](https://richardanaya.github.io/webidl-loader/examples/events/src/lib.rs)
